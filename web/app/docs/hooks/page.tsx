...
export default function HooksPage() {
    return (
        ...
        >
            <Section title="At a glance">
                <ul>
                    <li><strong><a href="#skip">tempaloo_skip_attachment</a></strong> — bypass conversion per attachment.</li>
                    <li><strong><a href="#quality">tempaloo_quality_for</a></strong> — override quality (1-100) per attachment.</li>
                    <li><strong><a href="#after">tempaloo_after_convert</a></strong> — fire on every successful conversion.</li>
                </ul>
            ...
            {/* ─── skip ──────────────────────────────────────────── */}
            <Section id="skip" title="tempaloo_skip_attachment">
                <P>Filter that decides whether an attachment should be converted at all. Return <code>true</code> to skip.</P>

                <H3>Signature</H3>
                <Pre lang="php" code={`apply_filters( 'tempaloo_skip_attachment',
    ...
    string $mode           // 'auto' | 'bulk'
                ...
                <Pre lang="php" code={`add_filter( 'tempaloo_skip_attachment', function( $skip, $id ) {
    ...
    return $skip;
            ...
            {/* ─── quality ───────────────────────────────────────── */}
            <Section id="quality" title="tempaloo_quality_for">
                ...
                <H3>Signature</H3>
                <Pre lang="php" code={`apply_filters( 'tempaloo_quality_for',
    ...
    string $format          // 'webp' | 'avif' (the chosen target)
                ...
                <Pre lang="php" code={`add_filter( 'tempaloo_quality_for', function( $q, $id, $format ) {
    ...
    return $format === 'avif' ? max( 50, $q - 10 ) : $q;
                ...
                <Pre lang="php" code={`add_filter( 'tempaloo_quality_for', function( $q, $id ) {
    $parent = wp_get_post_parent_id( $id );
    ...
    return $q;
            ...
            {/* ─── after ─────────────────────────────────────────── */}
            <Section id="after" title="tempaloo_after_convert">
                ...
                <H3>Signature</H3>
                <Pre lang="php" code={`do_action( 'tempaloo_after_convert',
    int   $attachment_id,
    array $info {
        ...
        array  $sizes;        // map of generated files: orig_basename => { file, bytes }
                ...
                <Pre lang="php" code={`add_action( 'tempaloo_after_convert', function( $id, $info ) {
    ...
    wp_remote_post( 'https://hooks.example.com/tempaloo', [
        ...
        'blocking' => false,                            // fire-and-forget
            ...
            <Section title="What's NOT a hook (yet)">
                ...
                <ul>
                    <li><code>tempaloo_before_convert</code> — pre-flight modify image bytes</li>
                    <li><code>tempaloo_convert_failed</code> — react to errors specifically</li>
                    <li><code>tempaloo_alternate_url</code> — customize how the .webp URL is computed</li>
                </ul>
            </Section>
        </DocPage>
    );
